      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-12">
        <div className="col-span-1 md:col-span-2">
          ...
          <p className="max-w-sm font-light text-sm leading-relaxed mb-6">
            Embracing the Essence of earth to bring you luxurious, natural
            skincare. Every jar and bottle holds the quiet wisdom of the forest.
          </p>
        </div>

        <div>
          <h3 className="font-sans font-bold text-xl text-background mb-6">Explore</h3>
        ...
        <div>
          <h3 className="font-sans font-bold text-xl text-background mb-6">Connect</h3>
          <ul className="space-y-4 text-sm font-light">
            <li>
              <a href="#" className="hover:text-secondary transition-colors">
                Contact Us
