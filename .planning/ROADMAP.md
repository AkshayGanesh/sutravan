...
- [ ] **Phase 6: Estimate Engine — Delivery Schema, Settings & Edge Function** - Server-side engine computes a normalized serviceability / cost / ETA / COD estimate from an admin-tunable zone-weight table, with all delivery data structures, RLS, and seeded defaults in place
...
| 6. Estimate Engine — Schema, Settings & Edge Function | v1.1 | 2/3 | In Progress|  |
