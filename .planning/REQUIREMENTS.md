...
- [x] **DLVR-03**: Admin can manage zone-weight rate slabs — estimated cost and ETA range per shipping zone × weight band
...
| DLVR-03 | Phase 10 — Admin Zone-Weight Rate Slab Editor | Complete |
